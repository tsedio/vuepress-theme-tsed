...
a new `Server` class that extends [`ServerLoader`](/packages/vuepress-theme-tsed/docs/server-loader.md).
...
and the [children controllers](/packages/vuepress-theme-tsed/docs/controllers.md).
...
See [Controllers](/packages/vuepress-theme-tsed/docs/controllers.md) section for more details
:::
