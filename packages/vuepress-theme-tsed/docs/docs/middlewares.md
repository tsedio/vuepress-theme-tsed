...
This method can use all parameters decorators as you could see with the [Controllers](/packages/vuepress-theme-tsed/docs/controllers.md) and return promise.
