...
First, thank you for considering contributing to vuepress-theme-tsed! It is people like you that make the open source community such a great community! 😊
...
- Code: take a look at the [open issues](https://github.com/TypedProject/vuepress-theme-tsed/issues). Even if you can't write code, commenting on them and showing that you care about a given issue matters. It helps us triage them.
...
vuepress-theme-tsed project uses [conventional commits](https://www.conventionalcommits.org/en/v1.0.0-beta.4/) as format commit message.
...
## How to work on vuepress-theme-tsed
### Setup

Clone your fork of the repository

```bash
$ git clone https://github.com/YOUR_USERNAME/vuepress-theme-tsed.git
```
...
[Gflow](https://www.npmjs.com/package/gflow) is a command line tool to help developers with the Git process used in vuepress-theme-tsed.
...
When your feature is ready to review, you can open a PR on vuepress-theme-tsed github.
...
- vuepress-theme-tsed follows the git flow to generate a release note. To write your commit message see [convention page](https://docs.google.com/document/d/1QrDFcIiPjSLDn3EL15IJygNPiHORgU1_OOAqWjiDU5Y/edit).
...
- Please create an issue before sending a PR if it is going to change the public interface of vuepress-theme-tsed or includes significant architecture changes.
- Feel free to ask for help from other members of the vuepress-theme-tsed team.
